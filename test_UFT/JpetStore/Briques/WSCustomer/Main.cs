/***************************************************************
    ...
    *  loss of information.
    *          
    *  To edit the test, open the file ‘WSCustomer.st’ 
    *  in HP Service Test.
     ***************************************************************/
...
@"<Arguments><Reponse>{Step.OutputProperties.HTTPActivity4.ResponseBody}</Reponse></Arguments>");
            ...
            VTDPropertyInfoBase pi3 = new VTDPropertyInfoBase("ResponseBody");
            VTDBaseGetter binding_getter2 = new VTDObjectGetter(pi3);
            VTDPropertyInfoBase pi4 = new VTDPropertyInfoBase("ExecutionOutputParameters","/*[local-name(.)='Arguments'][1]/*[local-name(.)='Reponse'][1]");
            VTDBaseSetter binding_setter2 = new VTDXPathSetter(pi4,XmlTypeCode.String);
            binding_setter2 = new StringFormaterDecorator(binding_setter2,"{Step.OutputProperties.HTTPActivity4.ResponseBody}");
            bind_dir2 = new BindDirection(_flow.HTTPActivity4,binding_getter2,binding_setter2,BindTargetType.ToInProperty);
            ...
            _flow.HTTPActivity4.Url = @"http://localhost:8080/api/customers";
            ...
            _flow.HTTPActivity4.Name = @"Demande HTTP4";
            _flow.HTTPActivity4.Proxy.Server = @"";
            _flow.HTTPActivity4.Proxy.Username = @"";
            _flow.HTTPActivity4.Proxy.Password = @"";
            _flow.HTTPActivity4.Authentication.Username = @"17QHNGMR81P6G7DFPS5VI1Y9D8HYWHFJ";
            _flow.HTTPActivity4.Authentication.Password = @"";
            _flow.HTTPActivity4.Authentication.PreemptiveAuthentication = true;
